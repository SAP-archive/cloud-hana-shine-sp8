...
sap.account.TileDialog.prototype.getHrefLocation = function(tileID) {
    switch (tileID) {
        ...
        case 2:
            return 'poworklist/poWorklist.html';
        case 3:
            return 'salesDashboard/index.html';
        case 4:
            return 'salesDashboard/soWorklist.html';
        case 5:
            return 'userCRUD/index.html';
        case 8:
            return '../spatial/ui/index.html';
        case 9:
            return '../fulltextsearch/ui/search.html';
        case 10:
            return 'salesDashMobile/index.html';
    }
}
