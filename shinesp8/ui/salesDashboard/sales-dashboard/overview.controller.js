sap.ui.controller("sales-dashboard.overview", {
    ...
    onInit: function() {
        ...
        var oSalesRegionModel = new sap.ui.model.odata.ODataModel("../../services/salesByRegion.xsodata", true);
        ...
        var oSalesCountryModel = new sap.ui.model.odata.ODataModel("../../services/salesByCountry.xsodata/", true);
        ...
        var oSalesRankModel = new sap.ui.model.odata.ODataModel("../../services/salesSalesRank.xsodata/", true);
